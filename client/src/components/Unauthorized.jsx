                ...
                <main className='w-25 p-4' style={{ height: 'fit-content' }}>
                    <div>
                        <div className='d-flex align-items-center flex-column'>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-lock-access" width="100" height="100" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#88afca" fill="none" strokeLinecap="round" strokeLinejoin="round">
