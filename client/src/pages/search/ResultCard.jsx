            ...
            <div className={styles.cardInterior}>
              <div className="d-flex flex-column justify-content-between h-100">
                <div className="d-flex flex-column justify-content-around h-100">
                  ...
                  <p className="card-title mb-0"> Dictado en {career.Institute.name}</p>
                </div>

                <div className="w-100 d-flex justify-content-center">
                  <button
                    type="button"
                    className="btn w-100 p-1 card-footer"
                    ...
                    <div className="modal-content">
                      ...
                      <div className="modal-body">
                        <div className="d-flex flex-column justify-content-between">
                          <div className="">
                            <h5 className="card-title mb-0"> Dictado en {career.Institute.name}</h5>
                            <p className="card-text mb-0">
                          ...
                          >
                            <Link
                              to={`/instituto/${career.Institute.id}`}
                              className="btn w-100 p-1"
                            >
                              Ver Carrera
                            </Link>
